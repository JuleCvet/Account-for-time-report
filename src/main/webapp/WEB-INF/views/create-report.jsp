    ...
    <form:form method="POST" modelAttribute="reportForm" class="form-signin">
		...
		<spring:bind path="companyName">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="companyName" class="form-control" placeholder="Name of report: "
         ...
         <spring:bind path="forDate">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="forDate" id="datepicker" class="form-control"
                            placeholder="For Date:"></form:input>
         ...
         <spring:bind path="hoursReported">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="hoursReported" class="form-control" placeholder="Reported hours:" autofocus="true"></form:input>
         ...
         <spring:bind path="vab">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="vab" class="form-control" placeholder="Hours for VAB" autofocus="true"></form:input>
         ...
         <spring:bind path="userID">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="hidden" value="${username.id}" path="userID" class="form-control"></form:input>
